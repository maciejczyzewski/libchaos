...
TEST(MIXINS, T__CHAOS_PASSWORD__DifferentTime) {
	...
	EXPECT_STREQ(b.c_str(), "9F64E0E63A39CD4D21E89896C95290FC56F9C0");
...
TEST(MIXINS, T__CHAOS_PASSWORD__DifferentPass) {
	...
	EXPECT_STREQ(d.c_str(), "6757C8B0B2C2DCB8986E5ADA9E6629837D70F46");
}
...
TEST(MIXINS, T__CHAOS_PASSWORD__DifferentSalt) {
	...
	EXPECT_STREQ(a.c_str(), "C67A0774E79BCBF84B2FCBAFC7C4F4057B8B045");
